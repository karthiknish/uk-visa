...
export default function Footer({
  ...
  return (
    <footer className="bg-[#003D6E] text-white" style={footerStyle}>
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-bold mb-4" style={titleStyle}>
              {title}
            </h3>
            <p className="text-sm text-gray-300 mb-4">
              Professional UK visa and immigration consultancy services.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start space-x-3 text-sm">
                ...
                <span className="text-gray-300">info@ukvisahelp.com</span>
              </li>
              <li className="flex items-start space-x-3 text-sm">
                <svg
                  className="w-5 h-5 mt-0.5 flex-shrink-0"
