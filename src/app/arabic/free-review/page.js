...
export default function FreeReviewArabic() {
  ...
  return (
    <>
      ...
      {/* Fallback can be null or a minimal loader since PageEffects renders no UI */}
      ...
      >
        <Navigation
          ...
          menuItems={[
            ...
            {
              href: "/arabic/free-review?scroll=form",
              label: "مراجعة مجانية",
            },
        ...
        <main className="min-h-screen bg-gray-50">
          ...
          {/* Main Content */}
          {/* Assign the ref to the section you want to scroll to */}
                ...
                <div className="mb-12">
                  ...
                  <FadeIn>
                    ...
                    <p className="text-lg mb-6">
                      ...
                      على الحماية القانونية التي تحتاجها. يمكننا مساعدتك في
                      الحصول على تصريح عمل. كما يمكننا مساعدتك في تجديد تصريح
                      عملك.
                    </p>
