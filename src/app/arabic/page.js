    ...
    <div className="min-h-screen font-[family-name:var(--font-geist-sans)]">
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <FadeIn direction="right" className="md:w-1/2" style={{ direction: 'rtl', textAlign: 'right' }}>
              <h1 className="text-4xl sm:text-5xl font-bold mb-6">خبراء التأشيرات والهجرة إلى المملكة المتحدة</h1>
              <p className="text-xl mb-8">استشارات متخصصة لجميع أنواع طلبات التأشيرات والهجرة إلى المملكة المتحدة</p>
              <motion.a 
                href="#services" 
      ...
      <main>
        <section className="py-16 container mx-auto px-6">
          <div className="flex flex-col md:flex-row gap-12">
            <FadeIn direction="up" delay={0.2} className="md:w-1/2" style={{ direction: 'rtl', textAlign: 'right' }}>
              <h2 className="text-3xl font-bold mb-6 text-[#003D6E]">نبذة <span className="text-black">عنا</span></h2>
              <div className="h-1 w-20 bg-[#003D6E] mb-6 mr-0"></div>
              <p className="mb-4 text-gray-700">
                شركة UK Visa Help Consultants هي إحدى شركات استشارات تأشيرات المملكة المتحدة الرائدة، وتضم فريقًا من الاستشاريين المتخصصين في طلبات تأشيرات الفيزا للمملكه المتحدة والإقامة. يتألف فريقنا من مستشارين وخبراء مدربين تدريبًا خاصًا، ليعطي اهتمامًا بالغًا لرعاية العملاء.
              </p>
              <p className="mb-6 text-gray-700">
                تتمتع UK Visa Help Consultants بخبراء في جميع مستويات شؤون الهجرة، ونركز على تقديم أفضل مساعدة ممكنة لكم. إذا كنتم تخططون للسفر أو الإقامة أو تمديد إقامتكم في المملكة المتحدة، فإن مستشارينا على أهبة الاستعداد لمساعدتكم أنتم وعائلتكم من خلال خدماتنا الاستشارية المخصصة في مجال الهجرة.
              </p>
              <motion.a 
                href="#contact" 
            ...
            <FadeIn direction="up" delay={0.4} className="md:w-1/2 bg-gray-100 rounded-lg p-8" style={{ direction: 'rtl', textAlign: 'right' }}>
              <h2 className="text-2xl font-bold mb-4 text-[#003D6E]">لماذا يختار عملاؤنا UK Visa Help Consultants؟</h2>
              <div className="h-1 w-20 bg-[#003D6E] mb-6 mr-0"></div>
              ...
              <p className="mb-4 text-gray-700">
                يختار العديد من العملاء UK Visa Help Consultants لتاريخنا الحافل بالخدمات الممتازة وسجلنا الحافل بالنجاحات. إلا اننا، نؤمن بأن أعظم نقاط قوتنا، وما يميزنا حقًا، هو فريقنا الصغير المتخصص الذي يقدم خدمات مخصصه للأفراد حسب حاله كل شخص. نحن نحب عملنا حقًا، ويسعد فريقنا بإحداث فرق في حياة عملائنا.
              </p>
        ...
        <section id="services" className="py-16 bg-gray-50">
          <div className="container mx-auto px-6">
            <FadeIn direction="up" className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 text-[#003D6E]" style={{ direction: 'rtl', textAlign: 'right' }}>خدماتنا <span className="text-black"></span></h2>
              ...
              <p className="max-w-2xl mx-auto text-gray-700" style={{ direction: 'rtl', textAlign: 'right' }}>
                نقدم مجموعة متكاملة من حلول التأشيرات والهجرة بناءً على احتياجات المتقدمين.
              </p>
            </FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <ScaleIn delay={0.2} className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow" style={{ direction: 'rtl', textAlign: 'right' }}>
                ...
                <h3 className="text-xl font-bold mb-2 text-center">الخدمات الشخصية والعائلية</h3>
              ...
              <ScaleIn delay={0.4} className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow" style={{ direction: 'rtl', textAlign: 'right' }}>
                ...
                <h3 className="text-xl font-bold mb-2 text-center">العمل والأعمال</h3>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
                    <span className="text-[#003D6E] mr-2">•</span>
              ...
              <ScaleIn delay={0.6} className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow" style={{ direction: 'rtl', textAlign: 'right' }}>
                ...
                <h3 className="text-xl font-bold mb-2 text-center">الطلاب والخريجين</h3>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
                    <span className="text-[#003D6E] mr-2">•</span>
            ...
            <FadeIn direction="up" delay={0.2} className="bg-white p-6 rounded-lg shadow" style={{ direction: 'rtl', textAlign: 'right' }}>
              <h3 className="text-xl font-semibold mb-4 text-[#003D6E]">خدمات أخرى تشمل:</h3>
        ...
        <section id="how-we-work" className="py-16 container mx-auto px-6">
          <FadeIn direction="up" className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-[#003D6E]" style={{ direction: 'rtl', textAlign: 'right' }}>طريقة <span className="text-black">عملنا</span></h2>
            <div className="h-1 w-20 bg-[#003D6E] mx-auto mb-6"></div>
            <p className="max-w-2xl mx-auto text-gray-700" style={{ direction: 'rtl', textAlign: 'right' }}>
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              >١</motion.div>
              <div className="pt-6">
                <h3 className="text-xl font-bold mb-4 text-center mt-4">أرسل بياناتك عبر الإنترنت</h3>
            ...
            >
              ...
              >٢</motion.div>
              <div className="pt-6">
                <h3 className="text-xl font-bold mb-4 text-center mt-4">مراجعة من قبل الخبراء</h3>
                <p className="text-gray-700 text-center">
            ...
            >
              ...
              >٣</motion.div>
              <div className="pt-6">
                <h3 className="text-xl font-bold mb-4 text-center mt-4">حلول مخصصة</h3>
                <p className="text-gray-700 text-center">
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row gap-12 items-center">
              <FadeIn direction="right" className="md:w-1/2" style={{ direction: 'rtl', textAlign: 'right' }}>
                <h2 className="text-3xl font-bold mb-4 text-[#003D6E]">مراجعة <span className="text-black">مجانية</span></h2>
                <div className="h-1 w-20 bg-[#003D6E] mb-6 mr-0"></div>
                ...
                <motion.a 
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >احصل على مراجعة مجانية</motion.a>
              </FadeIn>
              <div className="md:w-1/2 grid grid-cols-2 gap-4">
                <ScaleIn delay={0.2} className="bg-white p-5 rounded-lg shadow-md" style={{ direction: 'rtl', textAlign: 'right' }}>
                  ...
                  <p className="text-sm text-gray-600">لدينا سجل حافل من طلبات التأشيرات الناجحة</p>
                </ScaleIn>
                <ScaleIn delay={0.3} className="bg-white p-5 rounded-lg shadow-md" style={{ direction: 'rtl', textAlign: 'right' }}>
                  ...
                  <p className="text-sm text-gray-600">نضمن معالجة طلبك بأسرع وقت ممكن</p>
                </ScaleIn>
                <ScaleIn delay={0.4} className="bg-white p-5 rounded-lg shadow-md" style={{ direction: 'rtl', textAlign: 'right' }}>
                  ...
                  <p className="text-sm text-gray-600">احصل على استشارة من خبراء قانون الهجرة البريطاني</p>
                </ScaleIn>
                <ScaleIn delay={0.5} className="bg-white p-5 rounded-lg shadow-md" style={{ direction: 'rtl', textAlign: 'right' }}>
                  ...
                  <p className="text-sm text-gray-600">مستشار مخصص خلال عملية تقديم طلبك</p>
                </ScaleIn>
              </div>
            </div>
          </div>
